...
: THEN DUP >R CODEHERE SWAP ADDRESS-OFFSET R> 2 - CODE! ; IMMEDIATE
: ELSE 0x9999 COMPILE-BRANCH CODEHERE SWAP POSTPONE THEN ; IMMEDIATE

: BEGIN CODEHERE ; IMMEDIATE
: UNTIL 0x9999 COMPILE-BRANCH0 CODEHERE ADDRESS-OFFSET CODEHERE 2 - CODE! ; IMMEDIATE
...
: REPEAT 0x9999 COMPILE-BRANCH CODEHERE ADDRESS-OFFSET CODEHERE 2 - CODE! POSTPONE THEN ; IMMEDIATE
...
: BANK2-CALL ( "name" -- )
  2 POSTPONE BANK-CALL ; IMMEDIATE
: BANK3-CALL ( "name" -- )
  3 POSTPONE BANK-CALL ; IMMEDIATE
