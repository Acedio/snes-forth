...
game.out.fth: std.fth snes-std.fth joypad.fth sin-lut.fth oam.fth vram.fth cgram.fth maptiles.tiles.fth sprites.tiles.fth font.fth levels.fth level.fth game.fth 
	cat $^ > $@
