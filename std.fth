...
: IF 0x9999 COMPILE-BRANCH0 HERE ; IMMEDIATE
: THEN DUP >R HERE SWAP ADDRESS-OFFSET R> 2 - ! ; IMMEDIATE
: ELSE 0x9999 COMPILE-BRANCH HERE SWAP POSTPONE THEN ; IMMEDIATE

: BEGIN HERE ; IMMEDIATE
: UNTIL 0x9999 COMPILE-BRANCH0 HERE ADDRESS-OFFSET HERE 2 - ! ; IMMEDIATE
...
\ HERE 2 - is used below (and above) to update the branch offset (0x9999).
: REPEAT 0x9999 COMPILE-BRANCH HERE ADDRESS-OFFSET HERE 2 - ! POSTPONE THEN ; IMMEDIATE
